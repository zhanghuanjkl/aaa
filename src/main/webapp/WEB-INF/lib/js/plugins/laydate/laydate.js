    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
                ...
                var a = w.elem("div", {
                    ...
                    i = [function () {
                        var e = w.elem("i", {
                            "class": "layui-icon fa fa-angle-double-left laydate-prev-y"
                        });
                        return  e
                    }(), function () {
                        var e = w.elem("i", {
                            "class": "layui-icon fa fa-angle-left laydate-prev-m"
                        });
                        return  e
                    }(), function () {
                        var e = w.elem("div", {
                        ...
                        var e = w.elem("i", {
                            "class": "layui-icon fa fa-angle-right laydate-next-m"
                        });
                        return  e
                    }(), function () {
                        var e = w.elem("i", {
                            "class": "layui-icon fa fa-angle-double-right laydate-next-y"
                        });
                        return  e
                    }()],
                    d = w.elem("div", {
