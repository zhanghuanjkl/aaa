...
//    进入系统首页的跳转方法，传入的参数是： loginid=zhanghuan    password=123456zh
//    		[com.zichen.base.controller.system.LoginController] - 
//    		加密后的参数password是：c0e61f7aa90f7481557e83c88b4a434e
//    	a9b1004c7308f45baf305aaeebdeff4d  admin
//    	String str = "http://172.27.35.5:8080/ipcmsys/remoteFile/download?filePath\u003d/\u0026fileName\u003dmm.apk";
//    	str=java.net.URLDecoder.decode(str);
//    	String qq = "ygh12345678ui";
    	
    	
//    	System.out.println(getMd5String(qq));
